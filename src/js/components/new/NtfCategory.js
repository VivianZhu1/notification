        ...
        return(
            <div id="category" style={{margin:"50px", fontSize:"10pt",color:"#0f5b67", fontWeight:"bolder"}}>
                <div className="form-check" style={radioBtnStyle}>
                    ...
                    <label className="form-check-label" for="radio100">Announcement</label>
                </div>

                <div className="form-check" style={radioBtnStyle}>
                    <input className="form-check-input" name="group100" type="radio" id="radio101" checked/>
                    <label className="form-check-label" for="radio101">Marketing</label>
                </div>
            </div>
        );
    }
